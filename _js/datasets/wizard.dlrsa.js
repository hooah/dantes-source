framework.wizard.dlrsa.data.dataset = {
    ...
    "questions": [
        ...
        {
            "text": "Please select the statement that best describes your available time to study and work on assignments.",
            "subtext": "Consider all of your commitments, including work, family and recreational activities.",
            "category": 1,
            "choices": [
                {
        ...
        {
            "text": "Please select the statement that best describes you.",
            "subtext": "When answering this question, also consider how well organized you are with respect to completing your required military courses for promotion and other required training.)",
            "category": 2,
            "choices": [
                {
        ...
        },
        {
            ...
            "subtext": "Consider your ability to use word processing, spreadsheet, presentation software, e-mail, and the Internet",
            "category": 4,
            "choices": [
                {
                ...
                {
                    "text": "My computer skills are fair – I can use some but not all with confidence.",
