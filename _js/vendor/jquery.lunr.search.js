(function($) {
  ...
  var LunrSearch = (function() {
    ...
    LunrSearch.prototype.displayResults = function(entries) {
      ...
      if (entries.length === 0) {
        $entries.append('<li class="no-results"><h2>No results found!</h2><p><strong>No results found for your search query.  Please try different search keywords.</strong></p></li>')
      } else {
